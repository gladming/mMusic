...
// 播放器功能配置
var mkPlayer = {
    api: "http://47.112.4.147:86/music/api.php", // api地址
...
function audioPlay() {
    ...
    //缓存数据
    addTable('playList',Object.assign(music,{mid:music.source+'-'+music.id}));
	addFileCache([
        {id:music.source+'-'+music.id+'-'+'pic',url:music.pic},
        {id:music.source+'-'+music.id+'-'+'audio',url:music.url},
    ]);
